...
USERS = [ "Friendless", "sa266", "spellenclub ST", "PzVIE", "Damjon", "moorwild" ]
#USERS = [ "Damjon" ]
URLS = [ 
        ...
        "http://friendlessstats.dtdns.net/dynamic/choose/%s/consistency",
        "http://friendlessstats.dtdns.net/dynamic/choose/%s/playsByRanking",
